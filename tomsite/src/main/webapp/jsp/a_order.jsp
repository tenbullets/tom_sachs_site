...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=application.getContextPath() %>/css/a_order.css" >
        ...
        <div class="container_1">
            <div class="basic_inner">
                ...
                <div class="info">
                    ...
                    <h3 class="user"><%=user.getUsername()%></h3>
                    <a class="email" href="mailto:<%=user.getEmail()%>"><%=user.getEmail()%></a>
                </div>
